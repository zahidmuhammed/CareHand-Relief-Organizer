                        ...
                        <div class="collapse navbar-collapse main-menu-item justify-content-end"
                            ...
                            <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown_2">
                                        <a href="admindonation.php?logout='1'"  class="dropdown-item"> logout</a> 
    ...
    <section class="feature_part">
        <div class="container1">
           <div class="vertical-menu">
            ...
            <a href="#"  class="active">Donation Requests</a>
                   ...
                   <table border style="width: 150%;">
                       <thead class="heading"><th>DONATION ID</th><th>ITEMS</th><th>NAME</th><th>CONTACT NO</th><th>DISTRICT</th><th>ADDRESS</th><th>STATUS</th><th style="text-align: center;"><span class="ti-settings"></span></th></thead>
                               <?php
                                ...
                                {
                                    echo "<tr><td>{$row['d_id']}</td><td>{$row['items']}</td><td>{$row['name']}</td><td>{$row['contact']}</td><td>{$row['district']}</td><td>{$row['address']}</td><td><b>{$row['transaction']}</b></td>
