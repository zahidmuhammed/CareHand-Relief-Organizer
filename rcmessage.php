                            ...
                            <ul class="navbar-nav align-items-center">
                               ...
                               <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown_2">
                                        <a href="rcmessage.php?logout='1'"  class="dropdown-item"> logout</a> 
...
<!-- intro_video_bg start-->
    ...
    <style type="text/css">
        ...
        .container2{position: relative;left: 170px;top: 100px;}
    ...
    <section class="feature_part">
        <div class="container1">
           <div class="vertical-menu">
            ...
            <a href="#" class="active">Messages from admin</a>
        ...
        <div class="container2">
           <div class="userpage">
                            ...
                            <div class="block">
                                <table border style="text-align: center;width: 200%;">
                                    <thead style="background-color: #333332;color: #cecfc8;"><tr><th>DATE</th><th>TIME</th><th>MESSAGE</th></tr></thead>
                                <?php
                                $sql7="SELECT * FROM message2user Where rc_id='$id' ORDER BY date";
                                $res7=mysqli_query($db,$sql7);
                                $num7=mysqli_num_rows($res7);

                                        while ($row=mysqli_fetch_array($res7)) 
                                        {
                                        echo "<tr><td>{$row[3]}</td><td> {$row[4]} </td><td>{$row[2]}</td> </tr>";
                                        }
                                
                                ?>
                                </table>
                                <?php 
                                    if($num7==0){echo "<br>&nbsp;Zero Messages Found....";}
                                ?>
                            </div>
