                        ...
                        <div class="collapse navbar-collapse main-menu-item justify-content-end"
                            ...
                            <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown_2">
                                        <a href="adminvolunteer.php?logout='1'"  class="dropdown-item"> logout</a> 
...
<!-- intro_video_bg start-->
    ...
    <style type="text/css">
        ...
        .report{position: relative;left: 160px;top: 80px;height: 500px;width: 1400px; overflow-y: auto;}
    ...
    <section class="feature_part">
        <div class="container1">
           <div class="vertical-menu">
            ...
            <a href="#" class="active">Volunteers Info</a>
           ...
           <div class="home">
               <div class="report"><b>VOLUNTEERS</b>
                   <table border style="width: 100%;">
                       <thead class="heading"><th>NO</th><th>NAME</th><th>GENDER</th><th>AGE</th><th>AADHAR</th><th>CONTACT</th><th>ADDRESS</th><th>DISTRICT</th><th>STATUS</th><TH>RC ID</TH></thead>
                               ...
                               <?php
                                ...
                                {
                                    echo "<tr><td>{$row['v_id']}</td><td>{$row['v_name']}</td><td>{$row['v_gender']}</td><td>{$row['v_age']}</td><td>{$row['v_aadhar']}</td><td>{$row['v_contact']}</td><td>{$row['v_address']}</td><td>{$row['v_district']}</td><td>{$row['status']}</td><td>{$row['rc_id']}</td></tr>";
                                }
