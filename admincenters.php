                        ...
                        <div class="collapse navbar-collapse main-menu-item justify-content-end"
                            ...
                            <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown_2">
                                        <a href="admincenters.php?logout='1'"  class="dropdown-item"> logout</a> 
    ...
    <section class="feature_part">
        <div class="container1">
           <div class="vertical-menu">
            ...
            <a href="#"  class="active">Relief Centers</a>
           ...
           <div class="home">
               <div class="report"><b>RELIEF CENTERS</b>
                   <table border style="width: 150%;">
                       <thead class="heading"><th>RC ID</th><th>USER NAME</th><th>RC NAME</th><th>CONTACT NO</th><th>DISTRICT</th><th>ADDRESS</th><th>STATUS</th></thead>
                               <?php

                                $sql1="SELECT * FROM rc_register ORDER BY status";
                                $res1=mysqli_query($db,$sql1);
                                while($row=mysqli_fetch_array($res1,MYSQLI_ASSOC))
                                {
                                    echo "<tr><td>{$row['rc_id']}</td><td>{$row['user_name']}</td><td>{$row['rcname']}</td><td>{$row['contact']}</td><td>{$row['district']}</td><td>{$row['address']}</td><td>{$row['status']}</td></tr>";
                                }
