                            ...
                            <div class="vv" id="vv" >
                                ...
                                <input type="submit" name="submit" value="SUBMIT" style="background-color: #fff;border-radius: 4px;width: 100px;height: 40px;border:1px solid #00c424;">
                                   ...
                                   <table border style="width: 900px;text-align: center;">
                                        <thead style="background-color: #333332;color: #cecfc8;"><th>NO</th><th>NAME</th><th>GENDER</th><th>AGE</th><th>CONTACT</th><th>DISTRICT</th><th><span class='ti-settings'></span></th></thead>
                                        <?php
                                        ...
                                        $res4=mysqli_query($db,$sql4);
                                            ...
                                            {
                                            echo "<tr><td>{$row4['v_id']}</td><td>{$row4['v_name']}</td><td>{$row4['v_gender']}</td><td>{$row4['v_age']}</td><td>{$row4['v_contact']}</td><td>{$row4['v_district']}</td>
                                    ...
                                    <table border style="width: 900px;text-align: center;">
                                        ...
                                        $res5=mysqli_query($db,$sql5);
                                            ...
                                            {
                                            echo "<tr><td>{$row5['v_id']}</td><td>{$row5['v_name']}</td><td>{$row5['v_gender']}</td><td>{$row5['v_age']}</td><td>{$row5['v_contact']}</td><td>{$row5['v_district']}</td>
