                        ...
                        <div class="collapse navbar-collapse main-menu-item justify-content-end"
                            ...
                            <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown_2">
                                        <a href="adminmessage.php?logout='1'"  class="dropdown-item"> logout</a> 
...
<!-- intro_video_bg start-->
    ...
    <style type="text/css">
        ...
        .report textarea{border-radius: 5px;resize: none;border-color: #e8e8e8;width: 800px;height: 200px;}
        .report input[type='submit']{background-color: #00c424;border: none;color: #fff;border-radius: 5px;width: 150px;height: 30px;}
    ...
    <section class="feature_part">
        <div class="container1">
           <div class="vertical-menu">
            ...
            <a href="#" class="active">Message to RC</a>
           ...
           <div class="home">
               <div class="report"><b>SEND MESSAGES TO RELIEF CENTERS</b>
                    <form method="post">
                   <select name="rcid"><option value="select">SELECT RC</option>
                       <?php 
                       $query="SELECT * FROM rc_register where status='Active' ";
                   ...
                   <br><br><br><textarea  name="message" placeholder="Enter your message here.." required></textarea><br><br>
                   <input type="submit" name="submit" value="SEND" onclick =" return send();" >
                   </form>
                   ...
                   <?php 
                        ...
                        {
                            $rcid=mysqli_real_escape_string($db, $_POST['rcid']);
                            if ($rcid=="select") {
                                echo "Please select a relief center.";
                            }
                            else{
                            ...
                            $query2="INSERT INTO message2user (rc_id,message,date,time) VALUES ('$rcid','$message','$date','$time')";
                            mysqli_query($db,$query2);
                            echo "<font color='red'>Message send Succesively</font>";
            ...
            <div class="row justify-content-between">
                <div class="col-sm-6 col-md-4 col-xl-3">
                    <div class="single-footer-widget footer_1">
                        <a href="#"> <img src="img/favicon.png" alt=""> </a><font color="#fff">CareHand</font>
