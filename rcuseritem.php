                            ...
                            <ul class="navbar-nav align-items-center">
                               ...
                               <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown_2">
                                        <a href="rcuseritem.php?logout='1'"  class="dropdown-item"> logout</a> 
...
<!-- intro_video_bg start-->
    ...
    <style type="text/css">
        ...
        .container2{position: relative;left: 200px;top: 150px;}
        .requirement h4{color: brown;}
    </style>
    <section class="feature_part">
        <div class="container1">
           <div class="vertical-menu">
            <a href="rcuserhome.php" >RC Information</a>
            <a href="#" class="active">Supply Requirement</a>
        ...
        <div class="container2">
           <div class="userpage">
                            ...
                            <div class="requirement" id="req" style="display: block;">
                            <div>
                                <h4><span class="ti-shopping-cart"></span> Supply Requirement</h4><br><br>


                                <form method="post" name="additem" action="createrc.php?id=<?php echo $id ?>" enctype="multipart/form-data" id="additem">
                                <label>Item :</label><input type="text" name="item" required>
                                <label>Description :</label><input type="text" name="desc" required>
                                <label>Quatity :</label><input type="number" name="qty" required>
                                <input type="submit" value="ADD ITEM" style="background-color: #00c424;" name="additem" >
                                </form>

                            </div>
                            <div class="required"><br>
                                 
                                <table class="stock" border="2" style="background-color: #333332;color:#cecfc8 ; width: 70%;text-align: center;">
                                    <thead>
                                    ...
                                    <tbody style="background-color: #f1e8ff;color: #000">
                                        <?php 
                                        $db = mysqli_connect('localhost', 'root', '', 'carehand');
                                        $sql = "SELECT * FROM rc_stock WHERE  rc_id='$id' ";
