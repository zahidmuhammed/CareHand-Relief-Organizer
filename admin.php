...
<body>
    ...
    <style type="text/css">
        ...
        .fbox,.sbox,.tbox,.fbox,.dbox{height: 200px;width: 250px;background-color: #eee;margin-left: 70px;margin-top: 50px;box-shadow: inset 0 -3em 3em rgba(0,0,0,0.1),0 0 0 2px rgba(255,255,255,255),0.3em 0.3em 1em rgba(0,0,0,0.3) ;}
