...
<!-- intro_video_bg start-->
    ...
    <section> <!-- src="https://satelites.pro/Kerala_map"  -->
       <div > <iframe class="map" src="" style="height: 999px;width: 100%;"></iframe></div>
    </section>
    <style type="text/css">
        .map{
            background:url(img/kerala/map.png);
        }
    </style>
