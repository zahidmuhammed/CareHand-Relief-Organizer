...
<!-- intro_video_bg start-->
    ...
    <style type="text/css">
        ...
        .container2{position: relative;left: 20px;top: 150px;}
           ...
           <div class="userpage">
                            ...
                            <div class="persons">
                                <table border class="tbl" style="background-color: #333332;color:#fff;border-collapse: collapse;width: 300%;text-align: center;">
                                    <tr><td>No.</td><td>Name</td><td>Gender</td><td>DoB</td><td>Aadhar</td><td>Address</td><td>Mobile No</td><td>Change Status</td></tr>
                                    <tbody style="background-color: #f1e8ff;color: #000">
                                        ...
                                        {
                                        echo" <tr><td>{$row5['rfg_id']}</td><td>{$row5['rfg_name']}</td><td>{$row5['rfg_gender']}</td><td>{$row5['rfg_dob']}</td><td>{$row5['rfg_aadhar']}</td><td>{$row5['address']}</td><td>{$row5['rfg_contact']}</td>
