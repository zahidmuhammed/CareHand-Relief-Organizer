                        ...
                        <div class="collapse navbar-collapse main-menu-item justify-content-end"
                            ...
                            <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown_2">
                                        <a href="adminnewsfeed.php?logout='1'"  class="dropdown-item"> logout</a> 
...
<!-- intro_video_bg start-->
    ...
    <style type="text/css">
        ...
        .report{position: relative;left: 360px;top: 80px;}
    ...
    <section class="feature_part">
        <div class="container1">
           ...
           <div class="home">
               <div class="report"><b>NEWSFEED MANAGEMENT</b>
                   <form method="post">
                       <textarea name="news" style="resize: none;width: 600px;height: 100px;" placeholder="Type Headlines Here.." required></textarea><br>
                       <input type="submit" name="submit" value="ADD TO NEWSFEED" style="border: none;background-color: #00c424;color: #fff;border-radius: 4px;width: 150px;">
                   </form>
                   <?php
                    if(isset($_POST['submit']))
                    {
                        ...
                        $sql8="INSERT INTO newsfeed (news,date,time) VALUES ('$news','$date','$time') ";
                   ...
                   ?>
                    ...
                    <table border style="width: 150%;">
                        <thead class="heading"><th>NEWS</th><th>DATE</th><th>TIME</th><th>STATUS</th><th><span class='ti-settings'></span></th></thead>
                        <?php
                            $sql3="SELECT * FROM newsfeed ORDER BY date desc";
                            $res3=mysqli_query($db,$sql3);
                            while ($row3=mysqli_fetch_array($res3,MYSQLI_ASSOC)) 
                            {
                                echo "<tr><td>{$row3['news']}</td><td>{$row3['date']}</td><td>{$row3['time']}</td><td><b>{$row3['status']}</b></td><td><a href='change_news_status.php?nid={$row3['id']}'><span class='ti-reload' title='Change status'></span></a></td></tr>";
                            }
                        ?>
