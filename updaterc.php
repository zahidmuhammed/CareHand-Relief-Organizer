 <?php
   ...
   $query="SELECT * FROM rc_register WHERE rc_id='$id' and status = 'active'";
                ...
                <div class="col-xl-8">
                    <div class="section_tittle text-center">
                        ...
                        <table>
                        	...
                        	<tr><td><b>REFUGEES</b></td></tr>
                        	<tr><td>CAPACITY</td><td>:</td><td><input type="text" name="capacity" value="<?php echo $capacity;  ?>"></td></tr>
                        	
                        	<tr><td><b>VOLUNTEERS</b></td></tr>
                        	<tr><td>REQUIRED</td><td>:</td><td><input type="text" name="volunteer" value="<?php echo $volunteer;  ?>"></td></tr>
   		                </table><br><br>
   		                <input type="submit" name="update" value="UPDATE" style="background: #00c424; width: 400px">
   		                </form>
