    ...
    <section class="feature_part"><center><h3>DONATE SOME OF YOUR THINGS THAT YOU DON'T USE OR NEED ANYMORE.</h3></center>
        ...
        <div class="container" style="background-color: #1f1f1f; position: relative;color: #fff;height: 460px;">
               ...
               <div class="donate" style="position: relative;left: 360px;top: 20px;">
                <form method="post" >
                    <label><b>ITEMS</b></label><br><textarea style="resize: none;height: 150px;width: 400px;" name="items" required placeholder="Please Enter Items & details...."></textarea>
                    <table>
        ...
        <br>
        <div style="position: relative;left: 310px;font-weight: bold;">Our people will contact you to confirm your donation <b>>></b> Collects items that you donated from your doorstep <b>>></b> Our people will check item quality from there <b>>></b> Don't Hesitate to ask for receipt.  </div>
    </section>
    <!-- feature_part start-->
